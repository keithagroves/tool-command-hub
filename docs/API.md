...
**Version:** 2.0.0  
**Base URL:** `https://api.enact.tools/v1`
...
**Important Security Note**: Never trust the registry's `verification.verified` field. Always verify attestations locally using this bundle endpoint and the `@enact/trust` package to check against Rekor transparency log.
